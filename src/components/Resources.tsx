...
const resources: Array<Resource> = [
  {
    href: '/ai-search/overview',
    name: 'AI Search Deep Dive',
    description:
      'Understand ChatGPT, Perplexity, Google AI Overviews—how they work, differ, and what drives visibility.',
    icon: DocumentIcon,
    pattern: {
      y: 16,
      squares: [
  ...
  {
    href: '/strategies/quotes-statistics',
    name: 'Quotes & Statistics',
    description:
      'Research shows 30-40% visibility improvement with proper citations. Learn how to implement effectively.',
    icon: FolderIcon,
    pattern: {
      y: -6,
      squares: [
  ...
  {
    href: '/strategies/wikipedia',
    name: 'Wikipedia Strategy',
    description:
      'Wikipedia has 5x weight in training data and ~10% of AI citations. Learn how to build eligibility.',
    icon: BoltIcon,
    pattern: {
      y: 32,
      squares: [
  ...
  {
    href: '/strategies/reddit',
    name: 'Reddit Strategy',
    description:
      'Reddit is the #1 cited domain in AI search (~32% of citations). Build authentic presence effectively.',
    icon: CogIcon,
    pattern: {
      y: 22,
      squares: [[0, 1]],
