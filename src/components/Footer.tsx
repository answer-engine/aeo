...
function SmallPrint() {
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 dark:border-white/5">
      <div className="flex flex-col items-center gap-5 sm:flex-row sm:justify-between w-full">
        ...
        <div className="flex items-center gap-4">
          <Link
            ...
            className="flex items-center gap-1.5 text-xs text-zinc-500 hover:text-[#0A66C2] dark:text-zinc-400 dark:hover:text-[#0A66C2] transition-colors"
          >
      ...
      <p className="text-xs text-zinc-500 dark:text-zinc-400 flex items-center gap-1">
        Community-driven knowledge base. Made with{' '}
